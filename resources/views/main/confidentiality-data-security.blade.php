...
@section('keywords')
<title>Grand tax accuracy guarantee | Grand tax Filers </title>
<meta name="keywords" content="Grand tax  accuracy guarantee, taxact accuracy guarantee">
<meta name="description" content="Our customer service irs offers best us tax services againstcustomer service irs.  Our best tax service for business compared to other providers in the market">
<meta name="robots" content="index,follow">
<link rel="canonical" href="https://www.grandtaxfilers.com/main/confidentiality_data_security  ">
@endsection
@section('content')
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 pr-lg-5">
                <h1 class="font-weight-bold services_h1 text-center text-md-left">Confidentiality and Data Security</h1>

                <ul class="list-about-2 mt-sm-4 mt-3 text-md-left">
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Grand Tax filers protect clients’ data religiously with the strongest data security and privacy measures. As a trusted tax filing provider, we are fanatical about implementing and deploying new developments in the latest technologies related to data security.</li>
                    <li class="py-2"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>We actively monitor our security systems 24/7 onsite and remotely to prevent any data security breaches or hacks.</li>
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> We deeply think about data security in a 360 Degree Holistic manner that covers all aspects related to data security and privacy.</li>
                </ul>
            </div>
            <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-4">
                <img src="images/services/Confidentiality-&-Data-Security.jpg" alt="" class="img-fluid img-responsive" />
            </div>
        </div>
    </div>
</section>
