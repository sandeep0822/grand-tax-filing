...
@section('keywords')
<title>E-file taxes online free | US online tax filing </title>
<meta name="keywords" content="free e file taxes, e file state taxes free, free e file tax extension, e file taxes online free,us online tax filing">
<meta name="description" content="Lets us now help you free e file taxes without any great difficulty, this is one of our unique features to give you a simple free e file tax extension">
<meta name="robots" content="index,follow">
<link rel="canonical" href="https://www.grandtaxfilers.com/main/FBAR_and_FATCA  ">
@endsection
@section('content')
   <!-- inner banner -->
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 pr-lg-5">
                <h1 class="font-weight-bold services_h1 text-center text-md-left">FBAR & FATCA guidance and E-filing</h1>

                <ul class="list-about-2 mt-sm-4 mt-3 text-md-left">
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>FBAR and FATCA guidance is a very tricky aspect of taxation for people who are settled in the USA. Foreign Account Tax Compliance Act is an effective tool to regulate and control offshore tax evasion which happens due to the diversion of funds to and from offshore entities.</li>
                    <li class="py-2"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>The FINCEN or form 114(FBAR) as it is commonly known and FDBAR filing is a mandatory requirement for those who reside in the USA.</li>
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Grand Tax filers also assist in the detailed filing of the CIN CEN 114 form which is required to be filed during certain situations. You can trust Grand Tax filers for all these services and much more, just gives us a call and get the ball rolling now.</li>
                </ul>
            </div>
            <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-4">
                <img src="images/services/FBAR & FATCA Guidance and E-Filing.jpg" alt="" class="img-fluid img-responsive" />
            </div>
        </div>
    </div>
</section>
