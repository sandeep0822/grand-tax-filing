...
@section('keywords')
<title>ITIN application online | Grand tax filers </title>
<meta name="keywords" content="ITIN application, ITIN number application, ITIN application online, ITIN application requirements, apply for ITIN online">
<meta name="description" content="Why do you worry about the filing of your ITIN application, we are here to always help you out to fulfill all the needed ITIN application requirements">
<meta name="robots" content="index,follow">
<link rel="canonical" href="https://www.grandtaxfilers.com/main/itin_application ">
@endsection
@section('content')
   <!-- inner banner -->
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 pr-lg-5">
                <h1 class="font-weight-bold services_h1 text-center text-md-left">ITIN application guidance and assistance</h1>

                <ul class="list-about-2 mt-sm-4 mt-3 text-md-left">
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>ITIN is a 9 Digit number that is issued by IRS when it is determined that you are not qualified for a social security number. Grand Tax filers provide you with comprehensive support for obtaining an ITIN from IRS, ITIN is not a permanent number but has a Set date of expiry.
                       </li>
                    <li class="py-2"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Grand Tax filers have a select trained team of ITIN experts who process and address all your ITIN Related issues quickly and efficiently. </li>
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Grand Tax filers is an authorized IRS-certified provider and so do not worry, your ITIN application is safe in our hands and will be processed quickly and accurately on time by our team.</li>
                </ul>
            </div>
            <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-4">
                <img src="images/services/ITIN  Application Guidance and Assistance.jpg" alt="" class="img-fluid img-responsive" />
            </div>
        </div>
    </div>
</section>
