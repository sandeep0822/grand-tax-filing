    ...
    @section('keywords')
<title>Company Privacy Policy | Protect Your Privacy </title>
<meta name="keywords" content="privacy policy page, privacy policy, company privacy policy, protect your privacy, privacy policy statement">
<meta name="description" content="You can be totally assured of your date with our privacy policy. We have built strong safeguards into the company privacy policy for highest data security">
<meta name="robots" content="index,follow">
<link rel="canonical" href="https://www.grandtaxfilers.com/main/customer_support ">
@endsection
    @section('content')
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 pr-lg-5">
                <h1 class="font-weight-bold services_h1 text-center text-md-left">Customer support for 24/7 365 days</h1>

                <ul class="list-about-2 mt-sm-4 mt-3 text-md-left">
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>We have developed a strong core team of support specialists who are highly trained and always ready to help our customers with any queries as required.</li>
                    <li class="py-2"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Our live support lines are open 24/7 365 days a year to always give our end customers the best solutions whenever you need us. Our trained agents quickly manage your calls and try to give you the best solutions in the quickest possible time.</li>

                </ul>
            </div>
            <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-4">
                <img src="images/services/Customer-support-247.jpg" alt="" class="img-fluid img-responsive" />
            </div>
        </div>
    </div>
</section>
