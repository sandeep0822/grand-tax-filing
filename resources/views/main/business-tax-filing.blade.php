    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 pr-lg-5">
                <h1 class="font-weight-bold services_h1 text-center text-md-left">Business Tax Filing</h1>
               
                <ul class="list-about-2 mt-sm-4 mt-3 text-md-left">
                    <li class="py-1 text-justify"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> We help you with business tax return and assist you in the correct filing of taxes which are required as per state and federal laws. We also assist filing business taxes for LLC companies and also help companies do they ERC filing.  </li>
                    <li class="py-2 text-justify"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Our business tax filing is very comprehensive and covers all aspects of the filing as needed by the company and is verified by various tax experts whom we have in-house. These business tax returns are very invaluable for companies who need be legally correct within the IRS records.</li>
                    <li class="py-1 text-justify" ><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Business tax returns need to be filled with lot of care and should be carefully done without errors. Our expert team is there to update you on any aspect of business tax filing as required by business owners. We take them into strong confidence and help them file their taxes without much difficulty.</li>
                </ul>
            </div>
            <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-4">
                <img src="images/services/business-tax-filing.jpg" alt="" class="img-fluid img-responsive" />
            </div>
        </div>
    </div>
</section>
