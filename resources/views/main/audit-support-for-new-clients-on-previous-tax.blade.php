...
@section('keywords')
<title>income tax return filing | tax refund </title>
<meta name="keywords" content="tax refund, income tax return, income tax return filing, tax return estimate">
<meta name="description" content="We have a very robust confidentiality and data protection policy, this policy gives our customers data protection and confidentiality at all times">
<meta name="robots" content="index,follow">
<link rel="canonical" href=" https://www.grandtaxfilers.com/main/audit_support_for_new_clients_on_previous_tax ">
@endsection
@section('content')
   <!-- inner banner -->
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 pr-lg-5">
                <h1 class="font-weight-bold services_h1 text-center text-md-left">Audit support for new clients on previously filed tax returns</h1>

                <ul class="list-about-2 mt-sm-4 mt-3 text-md-left">
                    <li class="py-1"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Many of our clients feel that their returns have not been done correctly or when done by a different provider and want to have a re-review of the already filled tax returns. </li>
                    <li class="py-2"><i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>We do have a comprehensive audit support service available at very nominal charges with us which helps our customers re-audit existing returns to check if there are any discrepancies and any scope for any refund if mandated by the law. </li>

                </ul>
            </div>
            <div class="col-lg-6 about-2-secs-right mt-lg-0 mt-4">
                <img src="images/services/Audit-support-for-New.jpg" alt="" class="img-fluid img-responsive" />
            </div>
        </div>
    </div>
</section>
