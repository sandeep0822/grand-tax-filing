...
<head>
    ...
    <title>Admin Management | GRAND TAX FILERS</title>
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/admin/dashboard') }}" class="brand-link text-center">
                    <span class="brand-text text-center font-weight-light">Grand Tax Filer</span>
                </a>
            ...
            <footer class="main-footer">
                <strong>Copyright &copy; 2014-2021 <a href="{{ url('/admin/dashboard') }}">Grand Tax
                        Filer</a>.</strong>
                All rights reserved.
            </footer>
