                                    ...
                                    @if ($spouse_details)
                                        <tr>
                                            ...
                                            @if ($spouse_details->First)
                                                ...
                                                <td>
                                                    <a href="{{ asset('spouse_doc/' . $spouse_details->First) }}">View</a>
                                                </td>
                                            @else
                                                <td>
                                                    <span class="badge badge-danger">Not Found</span>
                                        ...
                                        <tr>
                                            ...
                                            @if ($spouse_details->Second)
                                                ...
                                                <td>
                                                    <a
                                                        href="{{ asset('spouse_doc/' . $spouse_details->Second) }}">View</a>
                                                </td>
                                            @else
                                                <td>
                                                    <span class="badge badge-danger">Not Found</span>
                                        ...
                                        <tr>
                                            ...
                                            @if ($spouse_details->Third)
                                                ...
                                                <td>
                                                    <a href="{{ asset('spouse_doc/' . $spouse_details->Third) }}">View</a>
                                                </td>
                                            @else
                                                <td>
                                                    <span class="badge badge-danger">Not Found</span>
