        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)->addIndexColumn()
                ...
                ->addColumn('action', function ($row) {
                    $viewbtn = '<a class="btn btn-primary p-1 ml-1" href="/view_user/' . $row->id . '"><i
                    class="fas fa-eye"></i></a>';
                    $editbtn = '<a class="btn btn-primary p-1 ml-1" href="/edit_user/' . $row->id . '"><i
                    class="fas fa-edit"></i></a>';
                    $creditbtn = '<a class="btn btn-primary p-1 ml-1" href="#"><i
                    class="fas fa-credit-card"></i></a>';
                    $trashbtn = '<a class="btn btn-danger p-1 ml-1" href="/delete_user/' . $row->id . '"><i
                    class="fas fa-trash"></i></a>';
                    $allbtns = "$viewbtn$editbtn$creditbtn$trashbtn";
                    return $allbtns;
                })
